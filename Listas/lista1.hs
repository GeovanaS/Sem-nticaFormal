...
-- Exercicio 2: Defina a função quantosSaoIguais :: Int -> Int -> Int -> Int que
...
-- Exercicio 3: Defina a função todosDiferentes :: Int -> Int -> Int -> Bool
...
-- Exercicio 4:  Defina um conjunto de testes para a função todosDiferentes
...
-- Exercicio 5: O que está errado com a seguinte definição de todosDiferentes:
...
-- Exercicio 7: Escreva uma definição de quantosSaoIguais que use a função todosDiferentes
...
-- Exercicio 8: Defina a função elevadoDois :: Int -> Int que recebe um argumento n
-- e devolve como resposta n^2
elevadoDois :: Int -> Int
elevadoDois n = n ^ 2

-- Exercicio 9: Defina a função elevadoQuatro :: Int -> Int que recebe um argumento n
...
-- Exercico 10: Supondo que exista uma função vendas: 
-- vendas :: Int -> Int 
